...
`thumbnailUrl` เป็นพารามิเตอร์เสริม (รูป JPEG สำหรับ preview วิดีโอ) — ถ้าไม่ใส่มา บอทจะใช้รูปสำรองของตัวเองแทน

คุณจะได้รับ**วิดีโอจริงที่เล่นดูได้ในแชท LINE** ตามด้วยข้อความพร้อมปุ่มใช่/ไม่ กดปุ่มใดปุ่มหนึ่ง แล้ว:
